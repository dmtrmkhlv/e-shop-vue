            ...
            <template v-if="goodCount > 0">
                <div class="menu__box">
                    <div class="menu__item">
                        ...
                        <router-link to="/checkout" class="button button__checkout">CHECKOUT</router-link>
                        <router-link to="/shopping-cart" class="button button__to__cart">GO TO CART</router-link>
                    </div>
                </div>
            </template>
            <template v-else>
